...
#' This function will randomly draw a subset of rows from a large file. This is ideal for finding distribution shape and properties from very large files- subject to one's compute memory maximum limit. This is also helpful for creating training models to export and run prediction data on.
#'
...
#'
#' @returns A sampled data frame as variable to investigate potentially useful columns during data loading of a large file.
#'
#' @export
